...
# p6 = Product.create(title: 'Cloth stretch shorts',size: "L",color: 'Tan',price: '35.00',category_id: c2.id)
# p7 = Product.create(title: 'Pattern Swim Trunks', size: 'L',color: "Multi",price: "34.99",category_id: c4.id)
